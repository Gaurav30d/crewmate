...
const IdeaGenerator = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Map simple string result to complex object structure
      const newIdeas = result.ideas.map((ideaText: string) => ({
        title: ideaText,
        type: contentType.length > 0 ? contentType[0] : "General",
        potential: "High", // Placeholder until backend returns metadata
        difficulty: "Medium",
        description: "Generated by CrewMate AI",
      }));
